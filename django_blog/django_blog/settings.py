...
SECRET_KEY = 'django-insecure-&tl8^n=!w7b5td00u#xbhu64)mo#9e#p2yfl*k56rhrygrk0vg'
...
DATABASES = {
       'default': {
           ...
           'USER': 'mydjangouser',  # Your database user
           'PASSWORD': 'mypassword',  # Your database password
           'HOST': 'localhost',      # Usually 'localhost' if PostgreSQL is on the same server
